                ...
                <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn-info delete-icon" id="restore" data-toggle="modal" data-target="#myRestore" data-id="{{$data->income_id}}" href="#"><i class="mdi mdi-backup-restore"></i></a>
                                <a class="btn-danger delete-icon" id="delete" data-toggle="modal" data-target="#myDelete" data-id="{{$data->income_id}}" href="#"><i class="mdi mdi-delete"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
