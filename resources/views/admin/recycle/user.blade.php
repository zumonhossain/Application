                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped table-hover custom_table">
                        ...
                        <tbody>
                            ...
                            <td>
                                <a class="btn-info delete-icon" id="restore" data-toggle="modal" data-target="#myRestore" data-id="{{$data->id}}" href="#"><i class="mdi mdi-backup-restore"></i></a>
                                <a class="btn-danger delete-icon" id="delete" data-toggle="modal" data-target="#myDelete" data-id="{{$data->id}}" href="#"><i class="mdi mdi-delete"></i></a>
                            </td>
                            </tr>
                            @endforeach
                        </tbody>
