        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="user-registration"><i class="mdi mdi-account-circle"></i> All Expense Recycle</h4>
                ...
                <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn-info delete-icon" id="restore" data-toggle="modal" data-target="#myRestore" data-id="{{$data->expense_id}}" href="#"><i class="mdi mdi-backup-restore"></i></a>
                                <a class="btn-danger delete-icon" id="delete" data-toggle="modal" data-target="#myDelete" data-id="{{$data->expense_id}}" href="#"><i class="mdi mdi-delete"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
