        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="user-registration"><i class="mdi mdi-account-circle"></i> Add Expense Category </h4>
                    <a href="{{url('admin/expense/category')}}" class="all_link"><i class="mdi mdi-grid"></i> All Category</a>
                </div>
                <div class="card-body">
                    @if(Session::has('success'))
                        <script type="text/javascript">
                            swal({title: "Success!", text: "Expense Category save Successfully", icon: "success", button: "OK", timer:5000,});
                        </script>
                    @endif
                    ...
                    @endif
                    <form method="post" action="{{url('admin/expense/category/submit')}}" class="form-horizontal">
                        @csrf
                        <div class="form-group row {{ $errors->has('name') ? ' has-error' : '' }}">
                            <label class="col-md-3 text-right control-label col-form-label"> Expense Category Name<span class="require_star">*</span></label>
                            <div class="col-md-7">
